    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roomType', models.CharField(choices=[('چادری', 'چادری'), ('روباز', 'روباز'), ('یخچالی', 'یخچالی'), ('کمپرسی', 'کمپرسی'), ('مسقف', 'مسقف'), ('کفی', 'کفی'), ('بفل دار', 'بقل دار')], default='', max_length=100, verbose_name='نوع اتاق')),
                ('vehichleType', models.CharField(choices=[('تریلی', 'تریلی'), ('جفت', 'جفت'), ('تک', 'تک'), ('خاور', 'خاور'), ('وانت و نیسان', 'وانت ونیسان'), ('خاور', 'خاور')], default='', max_length=100, verbose_name='نوع وسیله حمل کننده')),
