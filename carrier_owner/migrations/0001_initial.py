    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_ok', models.BooleanField(default=False, verbose_name='آیا تایید شده است؟')),
                ('is_changeable', models.BooleanField(default=True, verbose_name='قابل تغییر است ؟')),
                ('cargo_type', models.CharField(choices=[('inner_cargo', 'اعلام بار داخلی'), ('international_cargo', 'اعلام بار خارجی'), ('rail_cargo', 'اعلام بار ریلی')], max_length=20, verbose_name='نوع بار')),
                ...
                ('heavy_vehichle_others', models.CharField(default='', max_length=100, verbose_name='سایر')),
                ...
                ('inner_cargo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inner_cargo_carriers', to='carrier_owner.innercargo', verbose_name='اعلام بار داخلی')),
                ('international_cargo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='international_cargo_carriers', to='carrier_owner.internationalcargo', verbose_name='اعلام بار خارجی')),
            ],
            options={
