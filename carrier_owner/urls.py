...
urlpatterns = [
    ...
    path('list_road_fleet/',views.list_road_fleet,name='list_road_fleet_name'),
    ...
    path('car_ow_req_goods_owner/', views.car_ow_req_goods_owner, name='car_ow_req_goods_owner_name'),
]
