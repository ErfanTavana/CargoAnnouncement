...
from .serializers import RoadFleet2Serializer, DriverListCarrierOwner, CarOwReqDriverSerializer, \
    CarOwReqGoodsOwnerSerializer, RoadFleetSerializer
...
def list_road_fleet(request):
    ...
    if road_fleet.exists():
        # هشتگ: ایجاد serializer
        # Hash: Create serializer
        serializer = RoadFleet2Serializer(road_fleet, many=True)
