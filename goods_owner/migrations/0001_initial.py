    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination_area', models.CharField(blank=True, choices=[('گمرگ', 'گمرگ'), ('بندر', 'بندر'), ('ایستگاه', 'ایستگاه')], max_length=100, null=True, verbose_name='محدوده مقصد')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo_type_char_field', models.CharField(blank=True, max_length=255, null=True, verbose_name='نوع بار')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='deleted_by_%(class)s_set', to=settings.AUTH_USER_MODEL, verbose_name='حذف شده توسط ')),
