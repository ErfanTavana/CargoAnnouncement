    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrier_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carrier_owner_requests', to='accounts.carrierowner', verbose_name='صاحب  حمل کننده')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='deleted_by_%(class)s_set', to=settings.AUTH_USER_MODEL)),
                ('goods_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goods_owner_requests', to='accounts.goodsowner', verbose_name='صاحب بار')),
                ...
                ('required_carrier', models.ForeignKey(blank=True, null=True, on_delete=models.Model, to='goods_owner.requiredcarrier', verbose_name='درخواست حمل کننده')),
            ],
            options={
