    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('صاحب بار', 'صاحب بار'), ('صاحب حمل کننده', 'صاحب حمل کننده'), ('راننده', 'راننده')], max_length=150, verbose_name='نوع کاربری')),
                ('importance_level', models.CharField(blank=True, max_length=20, null=True, verbose_name='درجه اهمیت')),
